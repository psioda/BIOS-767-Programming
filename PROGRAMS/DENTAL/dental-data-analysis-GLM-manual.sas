...
*                                                                   
*-------------------------------------------------------------------
*  JOB NAME:       dental-data-analysis-GLM-manual.sas                                   
...
%setup(DENTAL-DATA-ANALYSIS-GLM-MANUAL,C:\USERS\PSIODA\DOCUMENTS\GITHUB\BIOS-767-PROGRAMMING);
...
proc IML;
  ...
  ods html path = "&outpath." file="Dental-General-Linear-Model-Analysis7-Manual.html" nogtitle;
