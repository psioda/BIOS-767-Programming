...
*                                                                   
*-------------------------------------------------------------------
*  JOB NAME:       dental-data-analysis-GLM-Covariance-Comparison.sas                                   
...
%setup(DENTAL-DATA-ANALYSIS-GLM-COVARIANCE-COMPARISON,C:\USERS\PSIODA\DOCUMENTS\GITHUB\BIOS-767-PROGRAMMING);
