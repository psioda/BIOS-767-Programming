...
*                                                                   
*-------------------------------------------------------------------
*  JOB NAME:       dental-data-analysis-GLM-Model-Comparison.sas                                   
...
%setup(DENTAL-DATA-ANALYSIS-GLM-MODEL-COMPARISON,C:\USERS\PSIODA\DOCUMENTS\GITHUB\BIOS-767-PROGRAMMING);
